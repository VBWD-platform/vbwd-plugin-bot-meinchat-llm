"""S98.4 — migration up/down/up for bot_llm_room_coupon (real PostgreSQL).
...
anchors on the plugin's OWN prior revision and the revision id is ≤ 32 chars.
"""
...
def test_revision_anchors_on_plugin_prior_and_id_is_short():
    assert migration.revision == "20260616_1100_bot_llm_room"
    assert migration.down_revision == "20260616_1000_bot_llm_rag"
